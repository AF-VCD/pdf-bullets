...
it("should render a short bullet all on one line", () => {
  ...
  render(<Bullet text={text} widthPx={widthPx} />, container);
...
it("should render a perfect sized bullet all on one line without optimiziation", () => {
  const text =
    "- This line should render on exactly one line, assuming 60 DPI, 12 pt Times New Roman font and a 202.321 mm width";
  const widthPx = 202.321 * DPMM;
...
it("should render a slightly multiline bullet all on one line with optimiziation, and it should be colored black", () => {
  const text =
    "- This line should optimize to fit on exactly one line, using 2006 Unicode spaces in place of the regular ones to compress";
  const widthPx = 202.321 * DPMM;
...
it("should appear as red if an optimized bullet is longer than one line", () => {
  const text =
    "- This bullet should be a little bit longer than a line, due to the fact that I am typing all of these words to fill up the space of the bullet.";
  const widthPx = 202.321 * DPMM;
  const enableOptim = true;
...
it("should render a slightly shorter bullet expanded out to minimize whitespace optimiziation, and it should be colored black", () => {
  const text =
    "- This line should optimize to fit on exactly one line, using 2004 Unicode spaces in place of regular spaces to fill space";
  const widthPx = 202.321 * DPMM;
  const enableOptim = true;
